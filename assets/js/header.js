(() => {
  ...
  // Booking-specific visual system lives in dedicated files.
  if (document.body.classList.contains("booking-page")) {
    const themeCss = document.createElement("link");
    themeCss.rel = "stylesheet";
    themeCss.href = "assets/css/booking-theme.css?v=2";
    document.head.appendChild(themeCss);

    const themeScript = document.createElement("script");
    themeScript.src = "assets/js/booking-theme.js?v=2";
    themeScript.async = false;
    document.head.appendChild(themeScript);
  }

  // CTA Prova Gratuita: open the choice page first, never the form directly.
